  ...
  <main class="print-page">
    ...
    <article v-else-if="payload" class="sheet">
      <OfficialDocumentHeader
        :header="null"
        :title="title"
        :issued-at-text="formatDateTime(payload.generatedAt)"
      ...
      <section v-if="payload.type === 'return'" class="two-col compact-section">
        <div>
...
/* ── OfficialDocumentHeader: scale to A5 (ref page is A4 at 10pt) ─────── */
...
/* ── Customer signature (single, full width) ─────────────────── */
.signature-box-full {
  border: 0.25mm solid #111827;
  height: 24mm;
  margin-top: 1.5mm;
