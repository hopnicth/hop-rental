...
| ---------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Home page content      | `/`                                        | `app/composables/useBanners.ts`, `app/composables/useHomeContent.ts`, `app/pages/index.vue` | `home_banners`, `home_link_cards`, `home_featured_products`, `home_featured_rental_accesses`, `products`, `rental_accesses` | Hero/link sections prefer curated DB rows; featured product/rental rails fall back to deterministic-random live catalog items when curated lists are empty. |
