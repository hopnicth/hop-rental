...
export const USER_PROFILE_SELECT_BASE =
  "id, full_name, phone, avatar_url, platform_role, membership_level, kyc_status, id_card_url, pdpa_consent_url, pdpa_consented_at, kyc_rejection_reason, created_at, updated_at";
...
): Partial<Record<"full_name" | "phone" | "avatar_url", string | null>> {
  const payload: Partial<Record<"full_name" | "phone" | "avatar_url", string | null>> = {};
